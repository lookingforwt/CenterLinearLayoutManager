...
public class LinearSmoothScroller2 extends RecyclerView.SmoothScroller {
    ...
    protected void onTargetFound(View targetView, RecyclerView.State state, Action action) {
        final int dx = calculateDxToMakeCenter(targetView);
        final int dy = calculateDyToMakeCenter(targetView);
     ...
     * snap preference.
     */
    public int calculateDyToMakeCenter(View view) {
     ...
     * snap preference.
     */
    public int calculateDxToMakeCenter(View view) {
        final RecyclerView.LayoutManager layoutManager = getLayoutManager();
